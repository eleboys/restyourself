...
/**
 * `BasicExtendedStrategy` constructor.
 *
 ...
 * @api public
 */
function BasicExtendedStrategy(options, verify) {
 ...
 */
util.inherits(BasicExtendedStrategy, passport.Strategy);
 ...
 * @api protected
 */
BasicExtendedStrategy.prototype.authenticate = function(req) {
 ...
 * @api private
 */
BasicExtendedStrategy.prototype._challenge = function() {
  return 'None realm="' + this._realm + '"';
}


/**
 * Expose `BasicExtendedStrategy`.
 */
module.exports = BasicExtendedStrategy;
